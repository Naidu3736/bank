...
class Bank:
    def __init__(self, locks: BankLocks, event_console: EventConsole, process_tracker: ProcessTracker):
        """
    ...
    def deactivate_card(self, card_number: str) -> bool:
        ...
        try:
            ...
            with self.locks.cards_lock:
                ...
                owner_pid = card.customer_id if isinstance(card, CreditCard) else card.account_id
                ...
                self.event_console.add_event(
                    ...
                    f"Tarjeta {card_type} {card_number} desactivada (Propietario: {owner_pid})",
                    "warning"
                )
                return True
